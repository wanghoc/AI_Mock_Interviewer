  ...
  return (
    <section className="flex flex-1 flex-col items-center justify-center py-8 sm:py-10">
      <div className="animate-fade-in-up w-full max-w-5xl text-center [animation-delay:120ms] [animation-fill-mode:both]">
        <p className="mb-5 text-xs uppercase tracking-[0.22em] text-slate-500">
          Next Generation Interview Simulator
        </p>

        <h1 className="font-[family-name:var(--font-space-grotesk)] text-4xl font-bold leading-tight text-slate-900 sm:text-6xl">
          Trải nghiệm
          <span className="bg-gradient-to-r from-sky-500 via-indigo-500 to-rose-400 bg-clip-text text-transparent">
            {" "}Phỏng vấn Tương lai
          </span>
        </h1>
